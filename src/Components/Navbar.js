...
export default function Navbar(props){
    ...
    return(
        <div className="navbar">
            ...
            <Link to="/runescape-mock-shop" className="navbarLink">Home</Link>
            <Link to="/runescape-mock-shop/shop" className="navbarLink">Shop</Link>
            <Link to="/runescape-mock-shop/cart" className="navbarLink">Cart({cartCount})</Link>
